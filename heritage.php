...
$category = "heritage"; // Set the category to heritage

$result = mysqli_query($conn, "SELECT * FROM photos WHERE category = '$category' ORDER BY uploaded_at DESC");
?>

<h2 class="heading" style="text-align:left; margin: 5px 200px;">Heritage Photography</h2>
...
<?php endwhile;
    ...
    <p class="message">No heritage photos found.</p>
<?php endif; ?>
</div>
